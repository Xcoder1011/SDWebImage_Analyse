...
typedef NS_OPTIONS(NSUInteger, SDWebImageOptions) {
     ...
     * 默认情况下，当一个URL不能下载，网址列入黑名单，所以库将不会继续尝试下载。
     */
     ...
     * 图像下载的过程中UI交互启动，例如当UIScrollView等正在滚动时，延迟下载图片（放置scrollView滚动卡）
     */
     ...
     * 启用允许不受信任的SSL证书。主要用于测试目的，在项目中谨慎使用
     */
